...
config = {
    ...
    "package_data": {
        name: [
            "DisplayCAL/beep.wav",
            "DisplayCAL/camera_shutter.wav",
            "DisplayCAL/ColorLookupTable.fx",
            "DisplayCAL/lang/*.yaml",
            "DisplayCAL/linear.cal",
            "DisplayCAL/pnp.ids",
            "DisplayCAL/presets/*.icc",
            "DisplayCAL/quirk.json",
            "DisplayCAL/ref/*.cie",
            "DisplayCAL/ref/*.gam",
            "DisplayCAL/ref/*.icm",
            "DisplayCAL/ref/*.ti1",
            "DisplayCAL/report/*.css",
            "DisplayCAL/report/*.html",
            "DisplayCAL/report/*.js",
            "DisplayCAL/test.cal",
            "DisplayCAL/theme/*.png",
            "DisplayCAL/theme/*.wav",
            "DisplayCAL/theme/icons/10x10/*.png",
            "DisplayCAL/theme/icons/16x16/*.png",
            "DisplayCAL/theme/icons/32x32/*.png",
            "DisplayCAL/theme/icons/48x48/*.png",
            "DisplayCAL/theme/icons/72x72/*.png",
            "DisplayCAL/theme/icons/128x128/*.png",
            "DisplayCAL/theme/icons/256x256/*.png",
            "DisplayCAL/theme/icons/512x512/*.png",
            "DisplayCAL/theme/jet_anim/*.png",
            "DisplayCAL/theme/patch_anim/*.png",
            "DisplayCAL/theme/splash_anim/*.png",
            "DisplayCAL/theme/shutter_anim/*.png",
            "DisplayCAL/ti1/*.ti1",
            "DisplayCAL/x3d-viewer/*.css",
            "DisplayCAL/x3d-viewer/*.html",
            "DisplayCAL/x3d-viewer/*.js",
            "DisplayCAL/xrc/*.xrc",
        ],
    },
